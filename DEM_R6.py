...
def generate_spheres(num_spheres, force_range, position_range, mass=1, radius=1):
    spheres =[]
...
if __name__ == "__main__":
    ...
    spheres = generate_spheres(num_spheres, force_range, position_range)
...
ani.save("./out/Spheres_2R1.gif", writer=writergif)
